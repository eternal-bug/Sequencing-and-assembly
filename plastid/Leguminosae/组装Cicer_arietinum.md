...
WORKING_DIR=${HOME}/stq/data/anchr/Cicer_arietinum
cd ${WORKING_DIR}
mkdir -p SRR5282968_1/2_illumina
cp ./SRR5282968/1_genome ./SRR5282968_1
for i in fastqc kmergenie sgaPreQC R1.fq.gz R2.fq.gz;
do
  cp -r ./SRR5282968/2_illumina/${i} ./SRR5282968_1/2_illumina
done

BASE_NAME=SRR5282968_1
cd ${WORKING_DIR}/${BASE_NAME}
